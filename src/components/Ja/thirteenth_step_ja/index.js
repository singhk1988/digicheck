...
import Fourteenth from "../fourteenth_step_ja";
    ...
    <div>{forward===false?(
      ...
      <Col span={24} className="start_title">
        <div className="question-container">
          ...
          Nutzen Sie Plan-BWA Werte, um ein Soll/Ist Vergleich für Ihre Mandanten durchzuführen?
          </h2>
